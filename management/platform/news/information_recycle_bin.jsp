...
<section class="rt_wrap" style="width:100%;">
<div class="inquiry_column">
			...
			<input type="button" value="查询" class="inquire" onclick="findInformationPage(1)">
	</div>
	...
	<div class="information_list">
      	...
      	<thead>
      	 	<tr>
        		...
        		<th class="information_edit_column">恢复</th>
...
<script type="text/javascript" charset="utf-8" src="<%=request.getContextPath()%>/commons/js/character_length_to_judge.js"></script>
<script type="text/javascript" charset="utf-8" src="<%=request.getContextPath()%>/commons/js/management/information_recycle_bin.js"></script>
</body>
</html>
