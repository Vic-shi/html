...
<body>
	...
	<div style="margin:9.2vw 4vw 0 4vw;">
		...
		<%-- <img src="<%=request.getContextPath()%>/commons/image/pic/pic_11.png" onclick="big()" style="width:92vw;height:46.6vw;margin-top:8.8vw;"> --%>
	</div>
...
<!-- 数据对接 Knight -->    
	<script type="text/javascript">
		$(function() {
			...
			var param = {"jsonStr":"{'informationId':"+contentId+"}"};
			console.log(param);
			$.ajax({
				type : "post",
				url : "<%=request.getContextPath()%>/api/information/loadByInformationId",
				data : param,
				dataType : "json",
				success : function(data) {
					...
					$('#title').html(information.informationTitle);
					$('#detail').html(information.informationDetail);
  ...
  //计算几天前
	...
	$(function(){
		$(".btn").click(function(){
			...
			$(location).attr('href', '<%=request.getContextPath()%>/client/index/find.jsp');
		});
	});
    </script>
</body>
