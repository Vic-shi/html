...
<div class="arrangement">
	...
	<section class="rt_wrap">
		<div class="master_head">
	      	<table id="table_head" class="master_table">
		      	<thead>
		      	 	<tr>
		        		...
		        		<th class="master_level_column">开始时间</th>
		        		<th class="master_status_column">状态</th>
		        		<th class="master_img_column">宣传图片</th>
		        		<th class="master_delect_column">替换</th>
		       		</tr>
	     		</thead>
	     		<tbody id="tbody_head"></tbody>
		    </table>
		    <div id="error_head"></div>
	      	<div class="page_selection" id="paging_head"></div>
	 	</div>
				...
				<div class="layui-form-item">
					<div class="layui-inline">
						...
						<select class="level"  id="authorStatus">
	        				...
	        				<option value="1">往期推荐</option>
	        				<option value="2">已删除</option>
	        				<option value="0">推荐中</option>
						</select>
						</div>
					</div>
				</div>
		...
		<div class="select_operating_column">
			...
			<span class="previous">往期推荐艺术家</span>
			<span class="adjunction"onclick="addAuthor()"><a href="<%=request.getContextPath()%>/management/erp/master/recommend_list.jsp">添加</a></span>
		</div>
	      	...
	      	<table id="table" class="master_table">
		      	<thead>
		      	 	<tr>
		        		...
		        		<th class="master_img_column">头像</th>
		        		<th class="master_level_column">级别</th>
		        		<th class="master_img_column">推荐时间</th>
		        		<th class="master_status_column">状态</th>
		        		<th class="master_delect_column">删除</th>
		       		</tr>
	     		</thead>
...
<!-- 封装的ajax.js文件 -->
<script type="text/javascript" charset="utf-8" src="<%=request.getContextPath()%>/commons/js/management/recommend_master.js"></script>
</body>
</html>
