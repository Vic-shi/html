...
<section class="rt_wrap">
	<div class="inquiry_column">
		...
		<input id="inquire" type="button" value="查询" onclick="findActivityPage(1)" class="inquire">
	...
	<div class="select_operating_column">
		...
		<span class="adjunction"><a href="<%=request.getContextPath()%>/management/platform/news/activity_add.jsp">添加</a></span>
	</div>
	<div class="activity_list">
      	...
      	<thead>
      	 	<tr>
        		...
        		<th class="activity_edit_column">编辑</th>
...
<script type="text/javascript" charset="utf-8" src="<%=request.getContextPath()%>/commons/js/management/activity.js"></script>
</body>
</html>
