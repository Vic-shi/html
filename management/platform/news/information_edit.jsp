...
<section class="rt_wrap">
		...
		<li class="lateral_alignment move_down">
			<div class="vertical_arrangement">
				<span>资讯id</span>
				<input id="informationId" type="text" disabled="disabled" class="input_box input_black">
			</div>
			<div class="vertical_arrangement">
				<span>资讯创建时间</span>
		...
		<li class="lateral_alignment move_down">
			...
			<div class="vertical_arrangement">
				<span>资讯标题</span>
				<input id="informationTitle" type="text" class="input_box input">
		...
		<li class="move_down">
			<input onclick="updateInformation()" class="determine_btn" type="button" value="确定">
		</li>
	</ul>
</section>
</div>
...
<script type="text/javascript" charset="utf-8" src="<%=request.getContextPath()%>/commons/js/management/information_edit.js"></script>
</body>
</html>
