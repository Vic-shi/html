	...
	<section class="rt_wrap">
		<div class="advertisement_list">
      		<table id="table" class="advertisement_table">
      			<thead>
      	 			<tr>
		        		<th class="advertisement_id_column">广告ID</th>
		        		<th class="advertisement_type_column">广告类型</th>
		        		<th class="advertisement_img_column">缩略图</th>
		        		<th class="advertisement_title_column">广告标题</th>
		        		<th class="advertisement_img_column">海报图</th>
...
<script type="text/javascript" charset="utf-8" src="<%=request.getContextPath()%>/commons/js/management/advertisement.js"></script>
</body>
</html>
