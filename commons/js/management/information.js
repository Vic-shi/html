...
function outPutPageContent(tbody, item) {
	...
	var str = "<tr>"
			...
			+"<td class='center'><img src='/web/commons/image/management/edit_icon.png' class='edit_icon' onclick='editInformation("+index+");'></td>"
...
function editInformation(i) {
	var informationId = arrInformationIds[i];
	sessionStorage.setItem("informationId",informationId);
	window.location.href='/web/management/platform/news/information_edit.jsp';
}
