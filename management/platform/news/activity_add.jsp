...
<section class="rt_wrap">
		...
		<li class="vertical_arrangement">
			<span>活动序号</span>
			<input id="activityId" readonly="readonly" type="text" class="input_box">
		</li>
		<li class="vertical_arrangement move_down">
			<span>活动标题</span>
			<input id="activityTitle" type="text" class="input_box">
		...
		<li class="vertical_arrangement move_down">
			...
			<span class="img_upload_error"></span>
		</li>
		<li class="vertical_arrangement move_down">
		...
		<li class="vertical_arrangement move_down">
			<span class="item_name">活动介绍：</span>
        	<script id="editor" type="text/plain"></script>
           	<span class="item_name_error"></span>
		</li>
		<li class="move_down">
			<input onclick="addActivity()" type="button" value="确定" class="determine_btn">
		</li>
	</ul>
</section>
</div>
...
<script type="text/javascript" charset="utf-8" src="<%=request.getContextPath()%>/commons/js/management/adctivity_add.js"></script>
</body>
</html>
