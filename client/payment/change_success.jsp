...
<html>
	...
	<body>
		<div class="head">
			<img src="<%=request.getContextPath()%>/commons/image/client/payment/pay_success.png" alt="交易成功" />交易成功（调换）
		</div>
		<div class="pro_change">
			<ul>
				<li>
					<h1 id="product">《札木便桥》</h1>
					<h1 id="author" style="font-size: 0.22rem;margin-bottom: 2vw;">作者：吴冠中</h1>
					<div class="img_show">
						<img  id="spic" src="<%=request.getContextPath()%>/commons/image/pic/pic_unpaid.png"/>
					</div>
				</li>
				<li>
					<img  src="<%=request.getContextPath()%>/commons/image/client/payment/change.png"/>
				</li>
				<li>
					<h1 id="changeproduct">《札木便桥》</h1>
					<h1  id="changeauthor" style="font-size: 0.22rem;margin-bottom: 2vw;">作者：吴冠中</h1>
					<div class="img_show">
						<img id="changepic" src="<%=request.getContextPath()%>/commons/image/pic/pic_unpaid.png"/>
					</div>
				</li>
			</ul>
			<div class="detail">
				...
				<h3>租期  <span id="ctime">2017-08-24</span> 至 <span id="endtime">2018-08-24</span></h3>
			</div>
		</div>
		...
		<div class="success_detail" style="height: 30vw;">
...
function orderdetail(url1,queryData){
	var param = {
		...
		successCallback: function(msg){
			var data =msg.data;
			$("#product").html(data[0].originalProductName); 
			...
			$("#author").html(data[0].originalProductAuthor); 
			
			$("#changeproduct").html(data[0].changeProductName); 
			$("#changeauthor").html(data[0].changeProductAuthor); 
