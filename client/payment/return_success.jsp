...
<html>
	...
	<body>
		<div class="head">
			<img src="<%=request.getContextPath()%>/commons/image/client/payment/pay_success.png" alt="交易成功" />交易成功（还画）
		</div>
		<div class="article">
			<div>
				<ul>
					<li><h1 id="product">《札木便桥》&nbsp;作者：吴冠中</h1><h1 style="background: none;color: red;">已逾期</h1></li>
					<li>
						<div class="img_show">
		...
		<div class="success_detail" style="height: 20vw;">
